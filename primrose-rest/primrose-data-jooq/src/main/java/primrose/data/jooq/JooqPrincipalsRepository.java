...
@Repository
public class JooqPrincipalsRepository implements PrincipalsRepository {

  private final DSLContext create;

  public JooqPrincipalsRepository(final DSLContext create) {
    this.create = create;
  }

  /* (non-Javadoc)
   * @see primrose.data.jooq.PrincipalsRepository#loadOperations()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see primrose.data.jooq.PrincipalsRepository#loadPermissions(java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see primrose.data.jooq.PrincipalsRepository#loadPrincipal(java.lang.String)
   */
  @Override
  @Cacheable("principals")
  public BaseOutputPrincipal loadPrincipal(final String username) {
    return create
      .select(
      ...
      .where(PRIMROSE.PRINCIPALS.NAME.eq(username))
      .fetchOptional(record -> ImmutableOutputPrincipal
        .builder()
  ...
  /* (non-Javadoc)
   * @see primrose.data.jooq.PrincipalsRepository#loadResources()
   */
  @Override
  @Cacheable("resources")
