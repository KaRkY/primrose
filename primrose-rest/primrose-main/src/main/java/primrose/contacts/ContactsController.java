...
public class ContactsController {
  ...
  @GetMapping(
    path = "/{contact}",
    produces = "application/vnd.primrose.contact.v.1.0+json")
  ...
  @PostMapping(
    consumes = "application/vnd.primrose.contact.v.1.0+json",
    produces = "application/vnd.primrose.contact.v.1.0+json")
  ...
  public ResponseEntity<PageableResource> list(
    ...
    final List<ContactResource> resource = contactResourceAssembler.toResource(contactsService.load(page, size, SortUtil.parseSort(sort)));
