...
public class EmailRepositoryImpl implements EmailRepository {
  ...
  @Override
  public ImmutableList<EmailFullDisplay> customerEmails(CodeId code) {
    return create
        .select(
            Tables.EMAILS.ID,
        ...
        .map(record -> EmailFullDisplay.builder()
            .id(record.get(Tables.EMAILS.ID))
            .type(record.get(Tables.EMAIL_TYPES.SLUG))
            .value(record.get(Tables.EMAILS.EMAIL))
  ...
  @Override
  public ImmutableList<EmailFullDisplay> customerEmailsForUpdate(CodeId code) {
    return create
        .select(
            Tables.EMAILS.ID,
            Tables.EMAIL_TYPES.SLUG,
  ...
  @Override
  public ImmutableList<EmailFullDisplay> contactEmails(CodeId code) {
    return create
        .select(
            Tables.EMAILS.ID,
            Tables.EMAIL_TYPES.SLUG,
  ...
  @Override
  public ImmutableList<EmailFullDisplay> contactEmailsForUpdate(CodeId code) {
    return create
        .select(
            Tables.EMAILS.ID,
            Tables.EMAIL_TYPES.SLUG,
